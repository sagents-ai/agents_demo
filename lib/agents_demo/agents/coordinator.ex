defmodule AgentsDemo.Agents.Coordinator do
  ...
  - `:timezone` - timezone string forwarded to the agent factory
  ...
  agent shutdown — when no viewers are present and the agent becomes idle, it
  can shutdown immediately to free resources.
  """
